...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-gray-900">Scan Document</h2>
        ...
        <div id="scanner-container" class="relative w-full aspect-video bg-gray-900 rounded-lg overflow-hidden">
            ...
            <div id="detect-highlight" class="hidden absolute z-20 border-[3px] border-green-400 rounded-lg shadow-[0_0_20px_6px_rgba(74,222,128,0.35)] pointer-events-none transition-all duration-200"></div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="border-t border-gray-200 pt-4 flex justify-end">
                    <button type="button" id="receive-btn"
                        class="px-6 py-2.5 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
...
<form id="receive-form" method="POST" action="" class="hidden">
    @csrf
</form>
@endsection
