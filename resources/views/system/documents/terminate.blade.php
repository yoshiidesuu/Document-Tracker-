...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-gray-900">Terminate Document</h2>
    ...
    <div id="result-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto overflow-x-hidden">
            ...
            <div class="p-6 space-y-6">
                ...
                <div id="terminate-reason-section" class="border-t border-gray-200 pt-4 hidden">
                    <h4 class="text-sm font-semibold text-red-600 mb-2">Termination Reason</h4>
                    <textarea id="terminate-reason" rows="3"
                        class="w-full rounded-lg border-red-300 shadow-sm focus:border-red-500 focus:ring-red-500 text-sm placeholder-red-300"
                        placeholder="Explain why this document needs to be terminated..."></textarea>
                    <p id="reason-error" class="text-xs text-red-600 mt-1 hidden">Please provide a reason for termination.</p>
                </div>

                <div class="border-t border-gray-200 pt-4 flex justify-end">
                    <button type="button" id="terminate-btn"
                        class="px-6 py-2.5 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                        Terminate Document
                    </button>
                </div>
            </div>
...
<form id="terminate-form" method="POST" action="" class="hidden">
    @csrf
</form>
@endsection
...
@push('scripts')
@vite(['resources/js/terminate.js'])
@endpush
